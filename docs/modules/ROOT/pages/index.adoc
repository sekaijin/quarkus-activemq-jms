...
If you want to use this extension, you need to add the `io.quarkiverse.activemq-jms:quarkus-activemq-jms` extension first to your build file.
...
include::includes/quarkus-activemq-jms.adoc[leveloffset=+1, opts=optional]
