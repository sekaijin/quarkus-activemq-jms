...
*/
package io.quarkiverse.activemq.jms.deployment;

import jakarta.enterprise.context.ApplicationScoped;
import jakarta.jms.ConnectionFactory;

import io.quarkiverse.activemq.jms.runtime.ConnectionFactoryWrapper;
import io.quarkiverse.activemq.jms.runtime.AmqJmsProducer;
import io.quarkiverse.activemq.jms.runtime.AmqJmsRecorder;
...
//        reflectiveClass.produce(ReflectiveClassBuildItem.builder(FailoverProvider.class).methods().build());
        ...
        reflectiveClass.produce(ReflectiveClassBuildItem.builder(ActiveMQConnectionFactory.class).methods().build());
